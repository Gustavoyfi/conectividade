...
class Send(threading.Thread):
    ...
    def run(self):
        # Listens for user input from command line send it to the
        ...
        while True:
            ...
            # If we type "QUIT" we leave the chatroo,
...
class Receive(threading.Thread):
    ...
    def run(self):
        ...
        #Receives data from the server and display it in the gui
...
class Client:
    ...
    def start(self):
        ...
        print("Trying to conncet to {}:{}...". format(self.host, self.port))
